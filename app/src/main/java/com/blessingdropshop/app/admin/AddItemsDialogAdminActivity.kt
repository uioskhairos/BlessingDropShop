...
import com.blessingdropshop.app.databinding.FragmentAddItemsDialogBinding
...
//            }
        ...
        binding.buttonAddItemDialog.setOnClickListener{
            ...
            val item = ItemModelAdd(binding.sellerUid.text.toString(),binding.sellerFullName.text.toString(), sellerShopName,binding.sellerRefUid.text.toString(), buyerFullName, itemAmount,itemHandlingFee, status,"", time)
