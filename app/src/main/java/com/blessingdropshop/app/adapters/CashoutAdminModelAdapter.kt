...
import com.blessingdropshop.app.admin.UpdateCashoutAdminActivity
import com.blessingdropshop.app.admin.UpdateItemAdminActivity
import com.blessingdropshop.app.models.AdminCashoutModel
...
class CashoutAdminModelAdapter(private val cashoutList: ArrayList<AdminCashoutModel>, val context: Context): RecyclerView.Adapter <CashoutAdminModelAdapter.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            com.blessingdropshop.app.R.layout.cashouts_list_admin,
            parent, false)
