...
import com.blessingdropshop.app.databinding.FragmentItemsBinding
...
class ItemsFragment : Fragment() {
    ...
    private fun addItem(){
        ...
        val item = ItemModelAdd(sellerUid,sellerFullName, sellerShopName, sellerRefUid, buyerFullName, itemAmount,handlingFee, status, "", "")
