...
import com.blessingdropshop.app.adapters.ItemAdminModelAdapter
import com.blessingdropshop.app.adapters.ItemsModelAdapter
import com.blessingdropshop.app.databinding.FragmentDroppedItemsBinding
import com.blessingdropshop.app.models.ItemModelAdd
...
class DroppedItemsFragment : Fragment(R.layout.fragment_dropped_items) {
    ...
    private lateinit var itemsArrayList: ArrayList<ItemModelAdd>
    private lateinit var filtereditemAdminArrayList: java.util.ArrayList<ItemModelAdd>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        itemsArrayList= arrayListOf<ItemModelAdd>()
        filtereditemAdminArrayList= arrayListOf<ItemModelAdd>()
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    for (i in snapshot.children){
                        val user = i.getValue(ItemModelAdd::class.java)
